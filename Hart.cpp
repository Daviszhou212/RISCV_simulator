...
{
  /* INSERT YOUR CODE HERE */
  URV v = SRV(intRegs_.read(di->op1())) < SRV(intRegs_.read(di->op2())) ? 1 : 0;
  intRegs_.write(di->op0(), v);
}
template <typename URV>
void
...
{
  /* INSERT YOUR CODE HERE */
  URV v = URV(intRegs_.read(di->op1())) <  URV(intRegs_.read(di->op2())) ? 1 : 0;
  intRegs_.write(di->op0(), v);
}
...
template <typename URV>
void
Hart<URV>::execBgeu(const DecodedInst* di)/*unsigned-int*/
{
  /* INSERT YOUR CODE HERE */
  URV v1 = intRegs_.read(di->op0()),  v2 = intRegs_.read(di->op1());
  if (v1 >= v2)
    {
      setPc(currPc_ + di->op2As<SRV>());/*current pc + offset*/
      lastBranchTaken_ = true;
    }
}
...
{
  /* INSERT YOUR CODE HERE */
  intRegs_.write(di->op0(), currPc_+4);/*save the address of next inst*/
  setPc(currPc_ + di->op1As<SRV>());/*current pc + offset*/
}
...
Hart<URV>::execJalr(const DecodedInst* di)
{
  /* INSERT YOUR CODE HERE */
  intRegs_.write(di->op0(), currPc_+4);/*save the address of next inst*/
  setPc((di->op2As<SRV>()+intRegs_.read(di->op1())) & 0x0fffffffe); 
}
...
{
  /* INSERT YOUR CODE HERE */
  SRV v1 = di->op1As<SRV>();/*get the immediate number DO NOT USE intRegs_.read!*/
  intRegs_.write(di->op0(), currPc_+v1);
}
