...
#pragma GCC diagnostic ignored "-Wpedantic"
  ...
  op2 = iform.immed();
  unsigned funct3 = iform.fields.funct3;
  if(funct3 == 0) return instTable_.getEntry(InstId::jalr);/*jalr*/
      }
      return instTable_.getEntry(InstId::illegal);

    l27:  // 11011  J-form JAL
      {
        /* INSERT YOUR CODE HERE */
  ...
  return instTable_.getEntry(InstId::jal);
    ...
    l12:  // 01100  R-form ADD SUB SLL SLT SLTU XOR SRL SRA OR AND
      {
      /* INSERT YOUR CODE HERE */
  RFormInst rform(inst);
  op0 = rform.bits.rd;
